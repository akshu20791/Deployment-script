...
RUN THE COMMAND IN NODES:  (run all the three lines together its a single command)
...
kubectl get nodes    #run this command in kubernetes master machine (controller machine)
